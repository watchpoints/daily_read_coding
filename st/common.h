...
#define ST_SWITCH_OUT_CB(_thread)                                                                                     \
    if (_st_this_vp.switch_out_cb != NULL && _thread != _st_this_vp.idle_thread && _thread->state != _ST_ST_ZOMBIE) { \
        _st_this_vp.switch_out_cb();                                                                                  \
    }
#define ST_SWITCH_IN_CB(_thread)                                                                                     \
    if (_st_this_vp.switch_in_cb != NULL && _thread != _st_this_vp.idle_thread && _thread->state != _ST_ST_ZOMBIE) { \
